...
public class Setup{
    public static void main(String[] args) {
        String[] data= {
            ...
            "'PB19DI8498', 'JT3HJ85J6T0133046', 'Maruti', 'Suzuki Grand Vitara', 5",
        ...
        try{
            ...
            // Data into table person
            statement.executeUpdate("insert into person values('admin', 100, 'admin', 'admin', 'admin', 0, 0);");
            statement.executeUpdate("insert into person values('default', 100, 'male', 'default', 'default', 0, 0);");
        }catch(Exception x){
